...
| 设计版本 | V1.5 |
| 更新日期 | 2026-07-17 |
| 适用基线 | `main` at `95836f3`，PR #21 合并后 |
| 已完成 | PR A、PR B、PR B.1、PR C、PR D、PR E、PR F、PR G |
| 当前实施项 | PR H：Artifact Identity / Blob |
| 下一实施项 | PR I：Artifact Recovery |
...
| R-08 | Heartbeat 和 Reaper 已解决；Reconciler 仍待 PR I | Artifact 崩溃恢复尚未验证 |
