...
$FrontendApiUrl = "http://127.0.0.1:18000"

Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$Root'; & '$Python' -m uvicorn app.main:app --app-dir backend --reload --host 127.0.0.1 --port 18000"
